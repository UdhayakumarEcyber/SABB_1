...
const MaintenanceSchedule: React.FunctionComponent<IMaintenanceScheduleProps2> =
  (props) => {
    ...
    let [NumOfDays, setNumOfDays] = React.useState<any>([]);
    let cardListView = [];
    ...
    let [currentTimeSlot, setcurrentTimeSlot] = React.useState<any>([]);
    let [more, setMore] = React.useState<any>([]);
    let [less, setLess] = React.useState<any>([]);
    ...
    function maindatainitial(value: any) {
      ...
      for (var t = 1; t <= 8; t++) {
        ...
        document.getElementById(t + "-HoursText").innerText =
          startSlotAt + ":" + "00";
        timeslots.push(startSlotAt);
        startSlotAt = startSlotAt + 1;
      }
      document.getElementById("company_list_ul").innerHTML = "";
      if(timeSlotNums[7] == 23)
      document.getElementById("downArrows").classList.add("disabled");
      else document.getElementById("downArrows").classList.remove("disabled");
      if(timeSlotNums[0] == 1)
      document.getElementById("upArrows").classList.add("disabled");
      else document.getElementById("upArrows").classList.remove("disabled");
      ...
      if (storeEventNum.length == 1) {
        document.getElementById("ButtonsDivParent").style.width = "13%";
        widthOfhr = "13%";
      } else if (storeEventNum.length == 2) {
        document.getElementById("ButtonsDivParent").style.width = "26%";
        widthOfhr = "26.3%";
      } else if (storeEventNum.length == 3) {
        document.getElementById("ButtonsDivParent").style.width = "40%";
        widthOfhr = "39.5%";
      } else if (storeEventNum.length == 4) {
        document.getElementById("ButtonsDivParent").style.width = "53%";
        widthOfhr = "52.8%";
      } else if (storeEventNum.length == 5) {
        document.getElementById("ButtonsDivParent").style.width = "65%";
        widthOfhr = "65%";
      ...
      setcurrentTimeSlot(timeslots);
      setNumOfDays(daysCount);
    }
    ...
    function upDownBtnEvent(no: any) {
      for (var i = 0; i < NumOfDays.length; i++) {
        var x = document.getElementById(NumOfDays[i] + "-card");
        if (no == 0) x.scrollTo(0, (currentTimeSlot[0] - 1) * 35);
        else if (no == 1) x.scrollTo(0, (currentTimeSlot[0] + 1) * 35);
      }
      var setTimings: any = [];
      if (no == 0) {
        for (var i = 0; i < currentTimeSlot.length; i++) {
          var h = currentTimeSlot[i] - 1;
          if (h != 0 || h > 0) {
            setTimings.push(h);
            document.getElementById(i + 1 + "-HoursText").innerText =
              h + ":" + "00";
          }
          if (more == true) {
            document.getElementById("downArrows").classList.remove("disabled");
            setMore(false);
          }
          if (h == 1) {
            document.getElementById("upArrows").classList.add("disabled");
        ...
        for (var i = 0; i < currentTimeSlot.length; i++) {
          ...
          if (less == true) {
            document.getElementById("upArrows").classList.remove("disabled");
            setLess(false);
          }
          if (hrs == 23) {
            document.getElementById("downArrows").classList.add("disabled");
          ...
          <div className="visitors_chart">
            ...
            <div className="company_data">
              <div className="company_data_timeslot">
                <div className="timingsOfCards">
                  <div className="HoursText" id="1-HoursText"></div>
                  <hr className="1-line" id="1-line" />
                </div>
                <div className="timingsOfCards">
                  <div className="HoursText" id="2-HoursText"></div>
                  <hr className="2-line" id="2-line" />
                </div>
                <div className="timingsOfCards">
                  <div className="HoursText" id="3-HoursText"></div>
                  <hr className="3-line" id="3-line" />
                </div>
                <div className="timingsOfCards">
                  <div className="HoursText" id="4-HoursText"></div>
                  <hr className="4-line" id="4-line" />
                </div>
                <div className="timingsOfCards">
                  <div className="HoursText" id="5-HoursText"></div>
                  <hr className="5-line" id="5-line" />
                </div>
                <div className="timingsOfCards">
                  <div className="HoursText" id="6-HoursText"></div>
                  <hr className="6-line" id="6-line" />
                </div>
                <div className="timingsOfCards">
                  <div className="HoursText" id="7-HoursText"></div>
                  <hr className="7-line" id="7-line" />
                </div>
                <div className="timingsOfCards">
                  <div className="HoursText" id="8-HoursText"></div>
                    ...
                    >
                      ...
                      >
                        {(() => {
                          return (
                            <div
                              className="totalhourData"
                              id={`${Nums[i]}-totalhourData`}
                            >
                              <div
              ...
              <div className="arrows" id="upArrows">
                <div
              ...
              <div className="arrows" id="downArrows" style={{ right: "3px" }}>
                <div
